...
class CNInstruct(Task):
    """
    Chinese Instruct SFT dataset.
    ...
    def __init__(self, split, subset="magpie", stack_turns=1, seed=42, **kwargs):
        """
        Args:
            split: "train" or "test"
        ...
        path = "/home/featurize/data/cn_instruct"
        ...
        if subset == "all":
            ...
            for sub in self.AVAILABLE_SUBSETS:
                try:
                    ...
                    d = load_dataset(path, sub, split="train")
                    ds_list.append(d)
            ...
            self.ds = load_dataset(path, subset, split="train")
